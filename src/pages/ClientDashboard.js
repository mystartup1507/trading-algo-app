          ...
          <div className="bg-zinc-900 border border-purple-500/30 rounded-3xl p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className={selectedMarket === 'indian' ? 'bg-purple-600 p-4 rounded-2xl font-bold flex items-center justify-center gap-2' : 'bg-zinc-800 p-4 rounded-2xl font-bold flex items-center justify-center gap-2'}
              >
                <Landmark size={18} />
                Indian Market
              </button>
              ...
              <button
                ...
                className={selectedMarket === 'forex' ? 'bg-cyan-600 p-4 rounded-2xl font-bold flex items-center justify-center gap-2' : 'bg-zinc-800 p-4 rounded-2xl font-bold flex items-center justify-center gap-2'}
              >
                <Globe size={18} />
                Forex/Crypto
              </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className={tradingMode === 'auto' ? 'bg-green-600 p-4 rounded-2xl font-bold' : 'bg-zinc-800 p-4 rounded-2xl font-bold'}
              >
                Auto Mode
              </button>
              ...
              <button
                ...
                className={tradingMode === 'manual' ? 'bg-yellow-600 p-4 rounded-2xl font-bold' : 'bg-zinc-800 p-4 rounded-2xl font-bold'}
              >
                Manual Pair
              </button>
            ...
            {tradingMode === 'manual' && (
              <input
                type="text"
                placeholder={selectedMarket === 'indian' ? 'Search Indian Pair' : 'Search Forex/Crypto Pair'}
                value={selectedPair}
